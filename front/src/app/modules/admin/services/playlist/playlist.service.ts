...
export class PlaylistService {
    ...
    public removeItem(idPlaylist: string, id: string): Observable<Boolean> {
        return this.httpHelper.HttpDelete<Model.Core.ApiResultItem<Boolean>>(environment.apiConfig.apiRoutes.playlist.playlistItem+ '/' + idPlaylist + '/' + id)
            .pipe(map(res => res.item));
    }
}