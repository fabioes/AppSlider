...
namespace AppSlider.Application.User.Services.Config
{
    public class UserConfigService : IUserConfigService
    {
        ...
        public async Task<UserResult> SwitchActive(UserConfigCommand command)
        {
            ...
            var domainUser = new Domain.Entities.Users.User(user.Id, user.Name, user.Username, user.Password, user.Profile, user.Email, user.Franchises, user.Roles, !user.Active, user.Blocked);
        ...
        public async Task<UserResult> ResetPassword(UserConfigCommand command)
        {
            ...
            var updatedUser = await userRepository.Update(new Domain.Entities.Users.User(user.Id, user.Name, user.Username, command.Password, user.Profile, user.Email, user.Franchises, user.Roles, !user.Active, user.Blocked));
