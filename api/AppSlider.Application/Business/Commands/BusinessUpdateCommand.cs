...
namespace AppSlider.Application.Business.Commands
{
    public class BusinessUpdateCommand
    {
        ...
        public BusinessUpdateCommand(Guid id, String name, String username, String password, String email, String profile, String franchises, String roles, Boolean active)
        {
            Id = id;
            Name = name;
            UserName = username;
